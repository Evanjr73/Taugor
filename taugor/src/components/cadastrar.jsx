...
function Cadastrar() {
    ...
    const generatePDF = (data) => {
        ...
        pdf.text(20, 120, `Setor: ${data.setor}`);
        pdf.text(20, 130, `Salario: ${data.salario}`);
        pdf.text(20, 140, `Admissão: ${data.admissao}`);
        pdf.text(20, 150, `Situação: ${data.situacao}`);
        ...
        <div className='container'>
            <div className='container2'>
                <div className='fale'>
                    ...
                    <p style={{ fontSize: "10px", margin: "0", marginTop: "10px", color: "#871F78" }}>Diga quem você é, como os empregadores podem entrar em contato com você e qual a sua profissão</p>
                </div>
                ...
                <div className='empreende'>
                    <div>
                        ...
                        <div className="containerinputen">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                            />
                            <p className='ppequeno'>ex: 15/11/1995</p>
                        </div>
                    ...
                    <div>
                        <div className='containerinputen'>
                            ...
                            />
                            <p className='ppequeno'>ex: 4.000,00</p>
                        </div>
                        <div className="containerinputen" style={{marginBottom:"52px"}}>
                            <input
                                type="text"
                                name="Setor"
                                placeholder="Setor"
                                ...
                                onChange={handleChange}
                            />
                            <p className='ppequeno'>ex: ADMINISTRAÇÃO</p>
                        </div>
                        <div className="containerinputen3">
                            <input
                                type="text"
                                name="Setor"
                                ...
                                onChange={handleChange}
                            />
                            <p className='ppequeno'>ex: Adimitido</p>
                        </div>
            ...
            <div className='buttonsnavigate'>
                ...
                <button className='bttnlista' onClick={() => navigate(`/lista`)}>Lista</button>
