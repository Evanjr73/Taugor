    ...
    <div className='container'>
      <div className='container2'>
        <div className='fale'>
          ...
          <p style={{ fontSize: "10px", margin: "0", color: "#871F78" }}>Diga quem você é, como os empregadores podem entrar em contato com você e qual a sua profissão</p>
        </div>
      ...
      <div className='buttonsnavigate'>
        <button className='btn' onClick={handleRegister}>PROXÍMO</button>
      </div>
    </div>
  );
}
